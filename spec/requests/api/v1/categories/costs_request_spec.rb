...
RSpec.describe 'Category costs requests', type: :request do
  let(:current_user) { create(:user, email: "abitgor@gmail.com", password: "12345679", currency: "UAH") }
  ...
  describe 'put #update' do
    ...
    it 'response is successful' do
      cost = create(:cost, amount: 0, user: current_user,category: category)
  ...
  describe 'post #create' do
    ...
    it 'response is successful' do
      ...
      expect(Cost.first.currency).to eq "UAH"
    end
  end

  describe 'delete #destroy' do
    let!(:cost) { create(:cost, amount: 0, user: current_user,category: category) }
  ...
  describe 'get #index' do
    let!(:costs) { create_list(:cost, 2, amount: 0, user: current_user,category: category) }
